...
class AccountAccount(models.Model):
    ...
    tax_sale_ok = fields.Boolean(string=u'ภาษีขาย', copy=False, track_visibility=True)
    tax_purchase_ok = fields.Boolean(string=u'ภาษีซื้อ', copy=False, track_visibility=True)
    cheque_in_ok = fields.Boolean(string=u'เช็ครับ', copy=False, track_visibility=True)
    cheque_out_ok = fields.Boolean(string=u'เช็คจ่าย', copy=False, track_visibility=True)
    deposit_ok = fields.Boolean(string=u'มัดจำ', copy=False, track_visibility=True)
